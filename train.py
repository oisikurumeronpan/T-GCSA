...
def main():
    ...
    parser.add_argument('-train_path_noisy', required=True)
    parser.add_argument('-train_path_clean', required=True)
    parser.add_argument('-val_path_noisy', required=True)
    parser.add_argument('-val_path_clean', required=True)
